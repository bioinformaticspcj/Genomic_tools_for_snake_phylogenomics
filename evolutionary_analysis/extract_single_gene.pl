...
#	print "prank -d=$_ -o=$_ -codon\n";
	...
	system("perl $dirs/pep_prank_and_trimal_html.pl $_.pep.fa") and die "can not execute perl $dirs/pep_prank_and_trimal_html.pl $_.pep.fa\n";
	system("perl $dirs/pep_trimal2cds_trimal.pl $_ $_.pep.fa.best.fas $_.pep.fa.best.fas.trimal.html > $_.trim") and die "can not execute perl $dirs/pep_prank_and_trimal_html.pl $_.pep.fa ";
